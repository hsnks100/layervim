...
function! KSOO()
    ...
    function! Kompile() 
        ...
        if executable('tmux')
            ...
            execute "setlocal makeprg=".b:buildstr
        endif
    endfunction
    ...
    if has("win32")
        ...
        noremap <F6> :cexpr system('./'.expand('%:r') .'< input.txt')<CR>:cope<CR><C-w>p
        noremap <C-S-B> :wa<CR>:call Kompile()<CR>
        autocmd FileType cpp noremap <buffer> <F5> :call Exekute()<CR>
    endif
...
call KSOO()
>>>>>>> 361817e1f7637bc9f1184168ef88f509fe686020
